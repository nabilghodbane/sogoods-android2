...
/**
 * Provides a view for each Brand's <code>Photo</code> that belongs to a brand.
 */
public class BrandPhotosAdapter extends BaseAdapter {
	 ...
	 */
	public BrandPhotosAdapter(Context context, int resource, List<Photo> items) {
		super();
	...
	/**
	 * Updates the adapters datasource with new photos from the
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		synchronized (imageCache) {
			bitmap = imageCache.get(photo.url);
		}
