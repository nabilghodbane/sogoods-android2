...
public class FuturaAutoCompleteTextView extends AutoCompleteTextView {
	...
	public FuturaAutoCompleteTextView(Context context) {
		super(context);
	}

	public FuturaAutoCompleteTextView(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	private static Typeface getTypeface(Context context, int typefaceValue) {
		...
		default:
			Log.e(ConstantsHelper.LOG_TAG,
					FuturaAutoCompleteTextView.class.getSimpleName() + ": "
