...
/**
 * Paints a tagged tab using <code>Canvas</code>.
 *
 */
public class QuestionTaggedTabDrawable extends Drawable {

	private int alpha;
	private ColorFilter colorFilter;

	public QuestionTaggedTabDrawable() {
	...
	private void drawTab(Canvas canvas) {
		...
		int[] colors = { Color.parseColor("#635451"),
				Color.parseColor("#382d28") };
		LinearGradient shader = new LinearGradient(startX, startTopLeftY, endX,
				endRightY, colors, null, Shader.TileMode.REPEAT);
	...
	private void drawTickMark(Canvas canvas) {
		...
		float[] points = { 161, 48, 174, 59, 174, 59, 195, 28 };
