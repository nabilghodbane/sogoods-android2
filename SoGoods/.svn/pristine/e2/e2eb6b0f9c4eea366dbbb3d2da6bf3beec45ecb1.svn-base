...
public class FuturaToggleButton extends ToggleButton {
	...
	public FuturaToggleButton(Context context) {
		super(context);
	}

	public FuturaToggleButton(Context context, AttributeSet attrs) {
		super(context, attrs);
		setTypeface(context, attrs);
	}

	public FuturaToggleButton(Context context, AttributeSet attrs, int defStyle) {
	...
	private static Typeface getTypeface(Context context, int typefaceValue) {
		...
		case FUTURA_STD_MEDIUM_OBLIQUE:
			...
			break;
		default:
			Log.e(ConstantsHelper.LOG_TAG,
					FuturaToggleButton.class.getSimpleName() + ": "
